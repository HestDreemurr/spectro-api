...
import { removeMusicController } from "./useCases/Playlists/RemoveMusic"
...
router.delete("/playlist/:playlist/remove/:music", authenticateUser, (request, response) => removeMusicController.handle(request, response))
